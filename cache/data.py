LOVE = [
    "ᴄʜᴇʀʀʏ 𝒀𝒂𝒓 𝑨𝒑𝒌𝒊 𝑩𝒂𝒕𝒆𝒏 𝑺𝒖𝒏 𝑲𝒂𝒓 𝑻𝒐 𝑴𝒖𝒋𝒆 𝑨𝒑𝒌𝒐 “𝑴𝒆𝒓𝒊 𝑱𝒂𝒂𝒏𝒖 𝑩𝒂𝒏𝒐𝒈𝒊” 𝑨𝒘𝒂𝒓𝒅 𝑫𝒆𝒏𝒆 𝑲𝒂 𝑴𝒂𝒏 𝑲𝒂𝒓 𝑹𝒂𝒉𝒂 𝒉𝒂𝒊",
    ...
    "ᴄʜᴇʀʀʏ 𝑫𝒐𝒄𝒕𝒐𝒓 𝑵𝒆 𝑨𝒅𝒗𝒊𝒄𝒆 𝑲𝒊𝒂 𝑯𝒂𝒊 𝑲𝒊 𝑺𝒐𝒏𝒆 𝑺𝒆 𝑷𝒂𝒉𝒍𝒆 𝑨𝒑𝒌𝒊 𝑷𝒊𝒄 𝑫𝒆𝒌𝒉, 𝑲𝒂𝒓 𝑺𝒐𝒏𝒂 𝑱𝒂𝒓𝒐𝒐𝒓𝒊 𝑯𝒂𝒊 𝑾𝒂𝒓𝒏𝒂 𝑯𝒆𝒂𝒓𝒕 𝑨𝒕𝒕𝒂𝒄𝒌 𝑨𝒂 𝑺𝒂𝒌𝒕𝒂 𝑯𝒂𝒊.",
    "𝑻𝒖𝒎𝒉𝒂𝒓𝒆 𝑫𝒊𝒍 𝑴𝒆 ᴄʜᴇʀʀʏ 𝑽𝒂𝒄𝒄𝒖𝒎 𝑪𝒍𝒆𝒂𝒏𝒆𝒓 𝑩𝒉𝒊 𝑳𝒈𝒂 𝑯𝒂𝒊 𝑲𝒚𝒂, 𝑩𝒉𝒖𝒕 𝑺𝒂𝒂𝒇 𝑫𝒊𝒍 𝑯𝒂𝒊 𝑻𝒖𝒎𝒉𝒂𝒓𝒂.",
    "ᴄʜᴇʀʀʏ 𝑻𝒖𝒋𝒌𝒐 𝒍𝒆𝒌𝒂𝒓 𝒎𝒆𝒓𝒂 𝒌𝒉𝒂𝒚𝒂𝒍 𝒏𝒉𝒊 𝒃𝒂𝒅𝒍𝒆𝒈𝒂, 𝑺𝒂𝒂𝒍 𝒃𝒂𝒅𝒍𝒆𝒈𝒂 𝒑𝒂𝒓 𝑫𝒊𝒍 𝒌𝒂 𝒉𝒂𝒂𝒍 𝒏𝒂𝒉𝒊 𝒃𝒂𝒅𝒍𝒆𝒈𝒂.",
    "तुम्हारे प्यार का इन्वेर्टर जबसे इस दिल में लगाया है तबसे इस दिल की बैटरी लो नहीं होती है !",
    "ᴄʜᴇʀʀʏ 𝑪𝒂𝒓 𝒎𝒆 𝑷𝒐𝒍𝒊𝒔𝒉 𝒌𝒂𝒓 𝒌𝒆 𝒃𝒉𝒊 𝑪𝒂𝒓 𝒖𝒕𝒏𝒊 𝒔𝒉𝒊𝒏𝒆 𝒏𝒂𝒉𝒊 𝒌𝒂𝒓𝒕𝒊 𝒋𝒊𝒕𝒏𝒂 𝑻𝒖𝒎 𝒃𝒊𝒏𝒂 𝒎𝒂𝒌𝒆𝒖𝒑 𝒌𝒆 𝒌𝒓𝒕𝒊 𝒉𝒐.",
    "ᴄʜᴇʀʀʏ 𝑱𝒊𝒕𝒏𝒂 𝒎𝒂𝒊 𝑬𝒙𝒂𝒎 𝒌 𝒏𝒐𝒕𝒆𝒔 𝒏𝒉𝒊 𝒅𝒆𝒌𝒉𝒕𝒂 𝒖𝒔𝒔𝒆 𝒋𝒚𝒅𝒂 𝑺𝒂𝒑𝒏𝒐 𝒎𝒆 𝒕𝒖𝒎𝒉𝒆 𝒅𝒆𝒌𝒉𝒕𝒂 𝒉𝒖",
...
GRP = "@AdulT_R00M|@DRACULA_CHEERY|@XD_CUTETY"

GROUP = [-1001735823928]

VERIFIED_USERS = [5572586305]

Owners = "@DRACULA_CHEERY"
